		...
		<div class="jugadores">
			<div class="">
				...
				<div style="margin-right: 0px; margin-left: 0px;" class="row mt2cms_rank_content">
					...
					<div class="col-md-4 top-inline top-inline-empire"><img src="<?php print $site_url; ?>images/empire/<?php print $empire=get_player_empire($player['account_id']); ?>.jpg" alt="<?php print empire_name($empire); ?>"></div>
				</div>
				<?php }
		...
		<div class="jugadores">
			<div class="">
				...
				<div style="margin-right: 0px; margin-left: 0px;" class="row mt2cms_rank_content">
					...
					<div class="col-md-4 top-inline top-inline-empire"><img src="<?php print $site_url; ?>images/empire/<?php print $empire=get_guild_empire($guild['master']); ?>.jpg" alt="<?php print empire_name($empire); ?>"/></div>
				</div>
				<?php }
