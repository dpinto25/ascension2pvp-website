    ...
    createDropdown: function() {
      ...
      var header = this.options.header ?
          ...
          donebutton = this.multiple && this.options.doneButton ?
            ...
            '</div>' : '',
          drop =
            '<div style="border: 1px solid #165568;" class="btn-group bootstrap-select' + multiple + inputGroup + '">' +
              '<button type="button" class="btn dropdown-toggle" style="background-image: none!important;" data-toggle="dropdown"' + autofocus + '>' +
    ...
    createLi: function() {
      ...
      var generateLI = function(content, index, classes, optgroup) {
        return '<li' +
            ...
            ((typeof index!=='undefined' & index!==null) ? ' style="border-bottom: 1px solid #375a7f;" data-original-index="' + index + '"' : '') +
